...
SL_quant$start=sapply(SL_quant$Start,function(x) min(as.numeric(strsplit(as.character(x),";")[[1]])))
SL_quant$end=sapply(SL_quant$End,function(x) max(as.numeric(strsplit(as.character(x),";")[[1]])))
